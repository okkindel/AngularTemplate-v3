...
const radioVariants = cva(
  `pointer-events-none absolute left-0 h-4 w-4 scale-50 opacity-0 transition-all duration-300
    peer-checked:scale-100 peer-checked:opacity-100 peer-disabled:cursor-not-allowed`,
  {
    variants: {
      mode: {
        primary: `fill-white stroke-white`,
        secondary: `fill-primary-500 stroke-primary-500 peer-hover:fill-primary-600
          peer-hover:stroke-primary-600 peer-focus:fill-primary-700`,
      },
    },
    defaultVariants: {
      mode: 'primary',
