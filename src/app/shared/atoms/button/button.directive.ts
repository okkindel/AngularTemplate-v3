...
const buttonVariants = cva(
  'inline-flex cursor-pointer items-center justify-center justify-self-center whitespace-nowrap rounded text-sm font-medium tracking-wide transition duration-300 focus-visible:outline-none',
  {
    variants: {
      mode: {
        primary:
          'bg-primary-500 text-white hover:bg-primary-600 focus:bg-primary-700',
        secondary:
          'bg-primary-50 text-primary-500 hover:bg-primary-100 hover:text-primary-600 focus:bg-primary-200 focus:text-primary-700',
        border:
...
@Directive({ selector: 'button[appButton]', standalone: true })
